 ...
 */const Sn=Symbol.for(""),vs=t=>{if((t==null?void 0:t.r)===Sn)return t==null?void 0:t._$litStatic$},gs=t=>{if(t._$litStatic$!==void 0)return t._$litStatic$;throw new Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)},mt=(t,...e)=>({_$litStatic$:e.reduce((o,i,n)=>o+gs(i)+t[n+1],t[0]),r:Sn}),Ii=new Map,fs=t=>(e,...o)=>{const i=o.length;let n,r;const s=[],l=[];let a=0,d=!1,c;for(;a<i;){for(c=e[a];a<i&&(r=o[a],(n=vs(r))!==void 0);)c+=n+e[++a],d=!0;a!==i&&l.push(r),s.push(c),a++}if(a===i&&s.push(e[i]),d){const m=s.join("$$lit$$");e=Ii.get(m),e===void 0&&(s.raw=s,Ii.set(m,e=s)),o=l}return t(e,...o)},ys=fs(b),bs="modulepreload",xs=function(t){return"/"+t},Pi={},g=function(t,e,o){if(!e||e.length===0)return t();const i=document.getElementsByTagName("link");return Promise.all(e.map(n=>{if(n=xs(n),n in Pi)return;Pi[n]=!0;const r=n.endsWith(".css"),s=r?'[rel="stylesheet"]':"";if(o)for(let a=i.length-1;a>=0;a--){const d=i[a];if(d.href===n&&(!r||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${s}`))return;const l=document.createElement("link");if(l.rel=r?"stylesheet":bs,r||(l.as="script",l.crossOrigin=""),l.href=n,document.head.appendChild(l),r)return new Promise((a,d)=>{l.addEventListener("load",a),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${n}`)))})})).then(()=>t()).catch(n=>{const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=n,window.dispatchEvent(r),!r.defaultPrevented)throw n})};function v(t,e,o,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,o):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(t,e,o,i);else for(var l=t.length-1;l>=0;l--)(s=t[l])&&(r=(n<3?s(r):n>3?s(e,o,r):s(e,o))||r);return n>3&&r&&Object.defineProperty(e,o,r),r}function _s(t){var e;const o=[];for(;t&&t.parentNode;){const i=To(t);if(i.nodeId!==-1){if((e=i.element)!=null&&e.tagName.startsWith("FLOW-CONTAINER-"))break;o.push(i)}t=t.parentElement?t.parentElement:t.parentNode.host}return o.reverse()}function To(t){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,i=Object.keys(o);for(const n of i){const r=o[n];if(r.getNodeId){const s=r.getNodeId(t);if(s>=0)return{nodeId:s,uiId:r.getUIId(),element:t}}}}return{nodeId:-1,uiId:-1,element:void 0}}function ws(t,e){if(t.contains(e))return!0;let o=e;const i=e.ownerDocument;for(;o&&o!==i&&o!==t;)o=o.parentNode||(o instanceof ShadowRoot?o.host:null);return o===t}const Es=(t,e)=>{const o=t[e];return o?typeof o=="function"?o():Promise.resolve(o):new Promise((i,n)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(n.bind(null,new Error("Unknown variable dynamic import: "+e)))})};var N;(function(t){t.text="text",t.checkbox="checkbox",t.range="range",t.color="color"})(N||(N={}));const Z={lumoSize:["--lumo-size-xs","--lumo-size-s","--lumo-size-m","--lumo-size-l","--lumo-size-xl"],lumoSpace:["--lumo-space-xs","--lumo-space-s","--lumo-space-m","--lumo-space-l","--lumo-space-xl"],lumoBorderRadius:["0","--lumo-border-radius-m","--lumo-border-radius-l"],lumoFontSize:["--lumo-font-size-xxs","--lumo-font-size-xs","--lumo-font-size-s","--lumo-font-size-m","--lumo-font-size-l","--lumo-font-size-xl","--lumo-font-size-xxl","--lumo-font-size-xxxl"],lumoTextColor:["--lumo-header-text-color","--lumo-body-text-color","--lumo-secondary-text-color","--lumo-tertiary-text-color","--lumo-disabled-text-color","--lumo-primary-text-color","--lumo-error-text-color","--lumo-success-text-color"],basicBorderSize:["0px","1px","2px","3px"]},Ss=Object.freeze(Object.defineProperty({__proto__:null,presets:Z},Symbol.toStringTag,{value:"Module"})),ae={textColor:{propertyName:"color",displayName:"Text color",editorType:N.color,presets:Z.lumoTextColor},fontSize:{propertyName:"font-size",displayName:"Font size",editorType:N.range,presets:Z.lumoFontSize,icon:"font"},fontWeight:{propertyName:"font-weight",displayName:"Bold",editorType:N.checkbox,checkedValue:"bold"},fontStyle:{propertyName:"font-style",displayName:"Italic",editorType:N.checkbox,checkedValue:"italic"}},X={backgroundColor:{propertyName:"background-color",displayName:"Background color",editorType:N.color},borderColor:{propertyName:"border-color",displayName:"Border color",editorType:N.color},borderWidth:{propertyName:"border-width",displayName:"Border width",editorType:N.range,presets:Z.basicBorderSize,icon:"square"},borderRadius:{propertyName:"border-radius",displayName:"Border radius",editorType:N.range,presets:Z.lumoBorderRadius,icon:"square"},padding:{propertyName:"padding",displayName:"Padding",editorType:N.range,presets:Z.lumoSpace,icon:"square"},gap:{propertyName:"gap",displayName:"Spacing",editorType:N.range,presets:Z.lumoSpace,icon:"square"}},Cs={height:{propertyName:"height",displayName:"Size",editorType:N.range,presets:Z.lumoSize,icon:"square"},paddingInline:{propertyName:"padding-inline",displayName:"Padding",editorType:N.range,presets:Z.lumoSpace,icon:"square"}},$o={iconColor:{propertyName:"color",displayName:"Icon color",editorType:N.color,presets:Z.lumoTextColor},iconSize:{propertyName:"font-size",displayName:"Icon size",editorType:N.range,presets:Z.lumoFontSize,icon:"font"}},ks=[X.backgroundColor,X.borderColor,X.borderWidth,X.borderRadius,X.padding],Ts=[ae.textColor,ae.fontSize,ae.fontWeight,ae.fontStyle],$s=[$o.iconColor,$o.iconSize],As=Object.freeze(Object.defineProperty({__proto__:null,fieldProperties:Cs,iconProperties:$o,shapeProperties:X,standardIconProperties:$s,standardShapeProperties:ks,standardTextProperties:Ts,textProperties:ae},Symbol.toStringTag,{value:"Module"}));function Cn(t){const e=t.charAt(0).toUpperCase()+t.slice(1);return{tagName:t,displayName:e,elements:[{selector:t,displayName:"Element",properties:[X.backgroundColor,X.borderColor,X.borderWidth,X.borderRadius,X.padding,ae.textColor,ae.fontSize,ae.fontWeight,ae.fontStyle]}]}}const Rs=Object.freeze(Object.defineProperty({__proto__:null,createGenericMetadata:Cn},Symbol.toStringTag,{value:"Module"})),Ns=t=>Es(Object.assign({"./components/defaults.ts":()=>g(()=>Promise.resolve().then(()=>As),void 0),"./components/generic.ts":()=>g(()=>Promise.resolve().then(()=>Rs),void 0),"./components/presets.ts":()=>g(()=>Promise.resolve().then(()=>Ss),void 0),"./components/vaadin-accordion-heading.ts":()=>g(()=>f(()=>import("./vaadin-accordion-heading-c0acdd6d-2c874e5a.js"),[],import.meta.url),[]),"./components/vaadin-accordion-panel.ts":()=>g(()=>f(()=>import("./vaadin-accordion-panel-616e55d6-86934402.js"),[],import.meta.url),[]),"./components/vaadin-accordion.ts":()=>g(()=>f(()=>import("./vaadin-accordion-eed3b794-cdc14a22.js"),[],import.meta.url),[]),"./components/vaadin-app-layout.ts":()=>g(()=>f(()=>import("./vaadin-app-layout-e56de2e9-00f46741.js"),[],import.meta.url),[]),"./components/vaadin-avatar.ts":()=>g(()=>f(()=>import("./vaadin-avatar-7599297d-df3f1f65.js"),[],import.meta.url),[]),"./components/vaadin-big-decimal-field.ts":()=>g(()=>f(()=>import("./vaadin-big-decimal-field-e51def24-46454e69.js"),["./vaadin-big-decimal-field-e51def24-46454e69.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-big-decimal-field-e51def24.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-board-row.ts":()=>g(()=>f(()=>import("./vaadin-board-row-c70d0c55-6b9f4b32.js"),[],import.meta.url),[]),"./components/vaadin-board.ts":()=>g(()=>f(()=>import("./vaadin-board-828ebdea-7cdfb6c3.js"),[],import.meta.url),[]),"./components/vaadin-button.ts":()=>g(()=>f(()=>import("./vaadin-button-2511ad84-edf8b209.js"),[],import.meta.url),[]),"./components/vaadin-chart.ts":()=>g(()=>f(()=>import("./vaadin-chart-5192dc15-f5356231.js"),[],import.meta.url),[]),"./components/vaadin-checkbox-group.ts":()=>g(()=>f(()=>import("./vaadin-checkbox-group-a7c65bf2-427a0d38.js"),["./vaadin-checkbox-group-a7c65bf2-427a0d38.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-checkbox-4e68df64-d6d450dc.js"],import.meta.url),["assets/vaadin-checkbox-group-a7c65bf2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-checkbox.ts":()=>g(()=>f(()=>import("./vaadin-checkbox-4e68df64-d6d450dc.js"),[],import.meta.url),[]),"./components/vaadin-combo-box.ts":()=>g(()=>f(()=>import("./vaadin-combo-box-96451ddd-b560fea1.js"),["./vaadin-combo-box-96451ddd-b560fea1.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-combo-box-96451ddd.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-confirm-dialog.ts":()=>g(()=>f(()=>import("./vaadin-confirm-dialog-4d718829-a6215fcf.js"),["./vaadin-confirm-dialog-4d718829-a6215fcf.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-confirm-dialog-4d718829.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-cookie-consent.ts":()=>g(()=>f(()=>import("./vaadin-cookie-consent-46c09f8b-9f8c95fe.js"),[],import.meta.url),[]),"./components/vaadin-crud.ts":()=>g(()=>f(()=>import("./vaadin-crud-8d161a22-14d6043e.js"),[],import.meta.url),[]),"./components/vaadin-custom-field.ts":()=>g(()=>f(()=>import("./vaadin-custom-field-42c85b9e-28990173.js"),["./vaadin-custom-field-42c85b9e-28990173.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-custom-field-42c85b9e.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-picker.ts":()=>g(()=>f(()=>import("./vaadin-date-picker-f2001167-6d68436a.js"),["./vaadin-date-picker-f2001167-6d68436a.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-date-picker-f2001167.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-time-picker.ts":()=>g(()=>f(()=>import("./vaadin-date-time-picker-c8c047a7-1c2198ab.js"),["./vaadin-date-time-picker-c8c047a7-1c2198ab.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-date-time-picker-c8c047a7.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-details-summary.ts":()=>g(()=>f(()=>import("./vaadin-details-summary-351a1448-14a76741.js"),[],import.meta.url),[]),"./components/vaadin-details.ts":()=>g(()=>f(()=>import("./vaadin-details-bf336660-b0e64a12.js"),[],import.meta.url),[]),"./components/vaadin-dialog.ts":()=>g(()=>f(()=>import("./vaadin-dialog-53253a08-d18a918e.js"),[],import.meta.url),[]),"./components/vaadin-email-field.ts":()=>g(()=>f(()=>import("./vaadin-email-field-d7a35f04-3e36ea7d.js"),["./vaadin-email-field-d7a35f04-3e36ea7d.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-email-field-d7a35f04.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-form-layout.ts":()=>g(()=>f(()=>import("./vaadin-form-layout-47744b1d-6af4996a.js"),[],import.meta.url),[]),"./components/vaadin-grid-pro.ts":()=>g(()=>f(()=>import("./vaadin-grid-pro-ff415555-72161301.js"),["./vaadin-grid-pro-ff415555-72161301.js","./vaadin-checkbox-4e68df64-d6d450dc.js","./vaadin-grid-0a4791c2-cf201e0f.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-grid-pro-ff415555.js","assets/vaadin-checkbox-4e68df64.js","assets/vaadin-grid-0a4791c2.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-grid.ts":()=>g(()=>f(()=>import("./vaadin-grid-0a4791c2-cf201e0f.js"),["./vaadin-grid-0a4791c2-cf201e0f.js","./vaadin-checkbox-4e68df64-d6d450dc.js"],import.meta.url),["assets/vaadin-grid-0a4791c2.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-horizontal-layout.ts":()=>g(()=>f(()=>import("./vaadin-horizontal-layout-3193943f-8fe26842.js"),[],import.meta.url),[]),"./components/vaadin-icon.ts":()=>g(()=>f(()=>import("./vaadin-icon-601f36ed-b36b20b7.js"),[],import.meta.url),[]),"./components/vaadin-integer-field.ts":()=>g(()=>f(()=>import("./vaadin-integer-field-85078932-d5d69191.js"),["./vaadin-integer-field-85078932-d5d69191.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-integer-field-85078932.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-list-box.ts":()=>g(()=>f(()=>import("./vaadin-list-box-d7a8433b-55ec424a.js"),[],import.meta.url),[]),"./components/vaadin-login-form.ts":()=>g(()=>f(()=>import("./vaadin-login-form-638996c6-d29c7a0e.js"),["./vaadin-login-form-638996c6-d29c7a0e.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-login-form-638996c6.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-login-overlay.ts":()=>g(()=>f(()=>import("./vaadin-login-overlay-f8a5db8a-9cbec2ff.js"),["./vaadin-login-overlay-f8a5db8a-9cbec2ff.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-login-overlay-f8a5db8a.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-map.ts":()=>g(()=>f(()=>import("./vaadin-map-d40a0116-10712cea.js"),[],import.meta.url),[]),"./components/vaadin-menu-bar.ts":()=>g(()=>f(()=>import("./vaadin-menu-bar-3f5ab096-88f4eb14.js"),[],import.meta.url),[]),"./components/vaadin-message-input.ts":()=>g(()=>f(()=>import("./vaadin-message-input-996ac37c-925e0d7c.js"),["./vaadin-message-input-996ac37c-925e0d7c.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-message-input-996ac37c.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-message-list.ts":()=>g(()=>f(()=>import("./vaadin-message-list-70a435ba-bcb88765.js"),[],import.meta.url),[]),"./components/vaadin-multi-select-combo-box.ts":()=>g(()=>f(()=>import("./vaadin-multi-select-combo-box-a3373557-c5546f33.js"),["./vaadin-multi-select-combo-box-a3373557-c5546f33.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-multi-select-combo-box-a3373557.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-notification.ts":()=>g(()=>f(()=>import("./vaadin-notification-bd6eb776-d5cbb2b7.js"),[],import.meta.url),[]),"./components/vaadin-number-field.ts":()=>g(()=>f(()=>import("./vaadin-number-field-cb3ee8b2-1e888261.js"),["./vaadin-number-field-cb3ee8b2-1e888261.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-number-field-cb3ee8b2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-password-field.ts":()=>g(()=>f(()=>import("./vaadin-password-field-d289cb18-5b8f98d6.js"),["./vaadin-password-field-d289cb18-5b8f98d6.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-password-field-d289cb18.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-progress-bar.ts":()=>g(()=>f(()=>import("./vaadin-progress-bar-309ecf1f-1d377b4f.js"),[],import.meta.url),[]),"./components/vaadin-radio-group.ts":()=>g(()=>f(()=>import("./vaadin-radio-group-88b5afd8-d0528764.js"),["./vaadin-radio-group-88b5afd8-d0528764.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-radio-group-88b5afd8.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-rich-text-editor.ts":()=>g(()=>f(()=>import("./vaadin-rich-text-editor-8cd892f2-fcd17557.js"),[],import.meta.url),[]),"./components/vaadin-scroller.ts":()=>g(()=>f(()=>import("./vaadin-scroller-35e68818-9796c664.js"),[],import.meta.url),[]),"./components/vaadin-select.ts":()=>g(()=>f(()=>import("./vaadin-select-df6e9947-d01d32a8.js"),["./vaadin-select-df6e9947-d01d32a8.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-select-df6e9947.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-side-nav-item.ts":()=>g(()=>f(()=>import("./vaadin-side-nav-item-34918f92-a6cce50b.js"),[],import.meta.url),[]),"./components/vaadin-side-nav.ts":()=>g(()=>f(()=>import("./vaadin-side-nav-ba80d91d-c37337e5.js"),[],import.meta.url),[]),"./components/vaadin-split-layout.ts":()=>g(()=>f(()=>import("./vaadin-split-layout-80c92131-aefb54bc.js"),[],import.meta.url),[]),"./components/vaadin-spreadsheet.ts":()=>g(()=>f(()=>import("./vaadin-spreadsheet-59d8c5ef-a5b536c3.js"),[],import.meta.url),[]),"./components/vaadin-tab.ts":()=>g(()=>f(()=>import("./vaadin-tab-aaf32809-dc24b304.js"),[],import.meta.url),[]),"./components/vaadin-tabs.ts":()=>g(()=>f(()=>import("./vaadin-tabs-d9a5e24e-183b00ae.js"),[],import.meta.url),[]),"./components/vaadin-tabsheet.ts":()=>g(()=>f(()=>import("./vaadin-tabsheet-dd99ed9a-a252577b.js"),[],import.meta.url),[]),"./components/vaadin-text-area.ts":()=>g(()=>f(()=>import("./vaadin-text-area-83627ebc-a62dd88c.js"),["./vaadin-text-area-83627ebc-a62dd88c.js","./vaadin-text-field-0b3db014-9aedd901.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-text-area-83627ebc.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-text-field.ts":()=>g(()=>f(()=>import("./vaadin-text-field-0b3db014-9aedd901.js"),[],import.meta.url),[]),"./components/vaadin-time-picker.ts":()=>g(()=>f(()=>import("./vaadin-time-picker-715ec415-ba0328ec.js"),["./vaadin-time-picker-715ec415-ba0328ec.js","./vaadin-text-field-0b3db014-9aedd901.js"],import.meta.url),["assets/vaadin-time-picker-715ec415.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-upload.ts":()=>g(()=>f(()=>import("./vaadin-upload-d3c162ed-890fbe9b.js"),["./vaadin-upload-d3c162ed-890fbe9b.js","./vaadin-button-2511ad84-edf8b209.js"],import.meta.url),["assets/vaadin-upload-d3c162ed.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-vertical-layout.ts":()=>g(()=>f(()=>import("./vaadin-vertical-layout-ad4174c4-aa6c4b3a.js"),[],import.meta.url),[]),"./components/vaadin-virtual-list.ts":()=>g(()=>f(()=>import("./vaadin-virtual-list-96896203-8e12990b.js"),[],import.meta.url),[])}),`./components/${t}.ts`);class Is{constructor(e=Ns){this.loader=e,this.metadata={}}async getMetadata(e){var o;const i=(o=e.element)==null?void 0:o.localName;if(!i)return null;if(!i.startsWith("vaadin-"))return Cn(i);let n=this.metadata[i];if(n)return n;try{n=(await this.loader(i)).default,this.metadata[i]=n}catch{console.warn(`Failed to load metadata for component: ${i}`)}return n||null}}const Ps=new Is,wt={crosshair:Pe`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
`;document._vaadintheme_twilightimperiumapp_componentCss||(st("vaadin-button",Vo(ol.toString())),document._vaadintheme_twilightimperiumapp_componentCss=!0);/**
 * @license
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class nl extends HTMLElement{static get is(){return"vaadin-lumo-styles"}static get version(){return"24.2.2"}}il(nl);const fe=(t,...e)=>{tl(`lumo-${t}`,e)};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const rl=w`
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */fe("utility",Xo);const yl=t=>{const e=[];t!==document&&(e.push(We(Ko.cssText,"",t,!0)),e.push(We(Yo.cssText,"",t,!0)),e.push(We(zn.cssText,"",t,!0)),e.push(We(Jo.cssText,"",t,!0)),e.push(We(Xo.cssText,"",t,!0)))},bl=yl;bl(document);export{ds as D,Ra as E,X as I,A as L,Z as N,ae as O,as as P,Sl as T,_l as X,wl as Z,f as _,fe as a,ls as b,w as c,il as d,we as e,Ka as f,$ as g,b as h,Yo as i,Ko as j,$o as k,N as l,$a as m,Ce as n,Ts as o,Cs as p,st as r,Pe as s,Pn as t,Vo as u,$s as w,Aa as x,ks as y};
